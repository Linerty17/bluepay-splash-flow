  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-100 relative">
      ...
      <div className="flex flex-col items-center p-4 mb-4">
        <h1 className="text-3xl font-bold mb-1">NGN 8,750</h1>
      ...
      <div className="bg-white m-4 p-3 rounded-lg border border-gray-200">
        <div className="mb-3">
          ...
          <div className="flex justify-between items-center">
            <p className="text-lg font-bold">NGN 8,750</p>
            <Button
              variant="default"
              size="sm"
              className="bg-blue-600 hover:bg-blue-700 flex items-center gap-1"
              onClick={() => handleCopy("8750", "Amount")}
            >
              <Copy size={14} />
              Copy
            </Button>
        ...
        <div className="mb-3 border-t pt-3">
          ...
          <div className="flex justify-between items-center">
            <p className="text-lg font-bold">7779330897</p>
            <Button
              variant="default"
              size="sm"
              className="bg-blue-600 hover:bg-blue-700 flex items-center gap-1"
              onClick={() => handleCopy("7779330897", "Account Number")}
            >
              <Copy size={14} />
              Copy
            </Button>
        ...
        <div className="mb-3 border-t pt-3">
          ...
          <p className="text-lg font-bold">CARBON BANK</p>
        </div>

        <div className="mb-3 border-t pt-3">
          <p className="text-gray-500 text-xs">Account Name</p>
          <p className="text-lg font-bold">MIRACLE STEPHEN</p>
        </div>
      </div>
